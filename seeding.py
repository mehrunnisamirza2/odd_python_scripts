...
def runSeeding(
    ...
    addDigitization(
        ...
        trackingGeometry,
        field,
        digiConfigFile="/Users/mehronish/project/acts/thirdparty/OpenDataDetector/config/odd-digi-smearing-config.json",
        rnd=rnd,
    )
    ...
    addSeeding(
        ...
        geoSelectionConfigFile="/Users/mehronish/project/acts/thirdparty/OpenDataDetector/config/odd-seeding-config.json",
        outputDirRoot=outputDir,
    )
    return s
...
if "__main__" == __name__:
    ...
    runSeeding(
        trackingGeometry, field, outputDir= os.getcwd() + "/seeding_output", seedingAlgorithm=args.algorithm
    ).run()
